...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    pdfGeneratedBy: "Generated by CyberGuardian Intelligence Engine",
    pdfDisclaimer:
    ...
    footerVersion: "CyberGuardian V1",
    footerCopyright: "© 2026 CyberGuardian",
  },
  ar: {
    ...
    trustedExecutiveLine:
      "Infrastructure موثوقة مع فجوات بسيطة في تقوية المتصفح.",
    suspiciousExecutiveLine:
      "تتطلب إشارات الثقة المرصودة مراجعة قبل السماح بتدفقات ثقة المستخدمين.",
    aiSummary: "AI Security Summary",
    executiveBrief: "موجز استخباراتي تنفيذي",
    aiDescription:
      "تفسير مترابط لأدلة الفحص وثقة Infrastructure والتعرض المهم من منظور المهاجم.",
    risk: "المخاطر",
    highInfrastructureTrust: "ثقة Infrastructure عالية",
    moderateInfrastructureTrust: "ثقة Infrastructure متوسطة",
    lowInfrastructureTrust: "ثقة Infrastructure منخفضة",
    aiStages: [
    ...
    noFingerprint: "لم يتم اكتشاف بصمة Framework أو Infrastructure عالية الثقة.",
    server: "Server",
    ...
    stages: {
      ...
      headers: "تم تقييم Security Headers",
      threat: "تم توليد Threat Intelligence",
    ...
    pdfThreatIntelligence: "Threat Intelligence",
    pdfTlsInfrastructure: "TLS و Infrastructure",
    pdfSecurityHeaders: "Security Headers",
    ...
    pdfScannerEngine: "Scanner Engine",
    pdfIntelligenceEngine: "Intelligence Engine",
    pdfGeneratedBy: "تم إنشاؤه بواسطة CyberGuardian Intelligence Engine",
    pdfDisclaimer:
    ...
    pdfInfrastructureTrust: "تقييم ثقة Infrastructure",
    pdfHeaderCoverage: "تغطية Headers",
    pdfRiskDistribution: "توزيع المخاطر",
    pdfAttackSurface: "سطح الهجوم",
    pdfInfrastructureExposure: "تعرض Infrastructure",
    easy: "سهل",
    moderate: "متوسط",
    advanced: "متقدم",
    fiveMinutes: "5 دقائق",

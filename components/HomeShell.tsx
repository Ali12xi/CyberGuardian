...
export default function HomeShell() {
  ...
  return (
    <PublicShell>
      <section className="relative isolate mx-auto w-full max-w-3xl overflow-hidden rounded-[2rem] px-3 py-4 text-balance text-center sm:px-6 sm:py-6">
        ...
        <div className="pointer-events-none absolute inset-x-10 top-0 z-0 h-px bg-gradient-to-r from-transparent via-cyan-300/20 to-transparent" />
        <p className="relative z-10 mx-auto mb-4 flex w-fit items-center gap-2 rounded-full border border-cyan-300/15 bg-cyan-300/[0.045] px-3 py-1 text-[0.68rem] font-semibold text-cyan-700 shadow-sm shadow-cyan-500/[0.02] dark:text-cyan-100 sm:mb-5">
          ...
          <span className="bidi-safe">{t.heroVersionLabel}</span>
        </p>
